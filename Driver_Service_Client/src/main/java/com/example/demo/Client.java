...
public class Client {
	...
	String BASEURL="http://localhost:8010/api/v1/users";//this line is for spring security
	//String BASEURL="http://localhost:8080/api/v1/drivers";
	
	//String BASEURL="http://10.90.3.53:8080/api/v1/drivers";
	...
	public void add() {
		...
		map.put("driverId", 102);
		map.put("driverName", "Archana");
		map.put("mobileNumber", 68934324);
		map.put("rating", 4.5);
